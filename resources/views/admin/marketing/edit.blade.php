<div class="modal-dialog">
    <div class="modal-content">
        ...
        <div class="modal-header">
            <h4 class="modal-title">Edit Marketing Fields</h4>
            ...
            <div class="modal-body">
                <div class="row">
                   <div class="col-sm-6">
                       ...
                       {!!Form::select('status', $options, $market->status, ['class' => "form-control status"])!!}
                       <span class="error"></span>
                   </div>
                   <div class="col-sm-6">
                        <label class=" form-control-label">Name</label>
                        <input type="text" name="name" value="{{$market->name}}" class="tag_name form-control">
                        <span class="error"></span>
                   </div>
                </div>
            </div>
