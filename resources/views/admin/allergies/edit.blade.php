<div class="modal-dialog">
    <div class="modal-content">
        ...
        <div class="modal-header">
            <h4 class="modal-title">Edit Allergy Fields</h4>
            <button type="button" class="close" data-dismiss="modal">&times;</button>
        </div>
        <!-- Modal body -->
        <form id="allergy_edit">
            <div class="modal-body">
                <div class="row">
                   <div class="col-sm-6">
                       ...
                       {!!Form::select('status', $options, $allergy->status, ['class' => "form-control status"])!!}
                       <span class="error"></span>
                   </div>
                   <div class="col-sm-6">
                        <label class=" form-control-label">Name</label>
                        <input type="text" name="name" value="{{$allergy->name}}" class="tag_name form-control">
                        <span class="error"></span>
                   </div>
                </div>
            </div>
