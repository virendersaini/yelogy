                                        ...
                                        <div class="card">
                                            <div class="card-header d-flex  justify-content-between ">
                                             ...
                                             <div class="card-body view-data-form">
                                                 <div class="form-group d-flex">
                                                  ...
                                                  <div class="form-group d-flex">
                                                     <label>Added Date</label>
                                                      {{beauty_date($user->created_at,'d/m/Y')}}
                                                 </div> 

                                                 <div class="form-group d-flex">
                                                     <label>Full Name</label>
                                                      {{ ucfirst($user->title) ?? ''}} {{ ucfirst($user->name) ?? ''}}
                                                 </div>  

                                                 <div class="form-group d-flex">
                                                     <label>Date of Birth</label>
                                                      {{ beauty_date(optional($user->helperdetails)->dob,'d/m/Y')}}
                                                 </div>  
                                                 ...
                                                 <div class="form-group d-flex">
                                                     <label>Area</label>
                                                      {{ $user->helperdetails->area ?? ''}}
                                                 </div>

                                                 <div class="form-group d-flex">
                                                     <label>County</label>
                                                      {{ $user->helperdetails->county ?? ''}}
                                                 </div>

                                                 <div class="form-group d-flex">
                                                     <label>Cleaning Area Avaiability</label>
                                                      BR3 , SW2 , NW1
                                                 </div> 

                                                 <div class="form-group d-flex">
                                                     <label>Cleaning Time Avaiability</label>
                                            ...
                                            <div class="card-body view-data-form">
                                                 <div class="form-group d-flex">
                                                     <label>UTR Number</label>
                                                      {{$user->helpervettings->UTR_number ?? ''}}
                                                 </div>

                                                 <div class="form-group d-flex">
                                                     <label>NI Number</label>
                                                      {{$user->helpervettings->NI_number ?? ''}}
                                                 </div>

                                                 <div class="form-group d-flex">
                                                     <label>Right to work</label>
                                                      {{ ucfirst(optional($user->helpervettings)->right_to_work) ?? ''}}
                                                 </div>

                                                 <div class="form-group d-flex">
                                                     <label>Visa</label>
                                                      {{ ucfirst(optional($user->helpervettings)->visa) ?? ''}} : {{ beauty_date(optional($user->helpervettings)->visa_date,'d/m/Y') }}
                                                 </div>
                                                 <div class="form-group d-flex">
                                                     <label>Photo ID</label>
                                                      @if(!empty($user->fetchFirstMediaUrl('helper_photo')))
                                                    <div class="img-responsive">
                                                        <img width="200" src="{{ $user->fetchFirstMediaUrl('helper_photo') }}">
                                                    </div>
                                                    @endif
                                                 </div>
                                                 <div class="form-group d-flex">
                                                    ...
                                                    <div class="img-responsive">
                                                        <img width="200" src="{{ $user->fetchFirstMediaUrl('helper_address_proof') }}">
                                                    </div>
                                                    @endif
                                                 </div> 
                                                 ...
                                                 <div class="form-group d-flex">
                                                     <label>Insurance</label>
                                                      {{optional($user->helpervettings)->insurance ?? ''}}
                                                 </div> 

                                                 <div class="form-group d-flex">
                                                     <label>Policy No</label>
                                                      {{optional($user->helpervettings)->policy_no ?? ''}}
                                                 </div> 
                                                 ...
                                                 <div class="form-group d-flex">
                                                    ...
                                                    <div class="img-responsive">
                                                        <img width="200" src="{{ $user->fetchFirstMediaUrl('helper_upload_policy') }}">
                                                    </div>
                                                    @endif
                                                 </div> 

                                                 <div class="form-group d-flex">
                                                     <label>UK Reference Name</label>
                                                     {{ $user->helpervettings->UK_reference_name1 ?? ''}}
                                                 </div> 
                                            ...
                                            <div class="card-body view-data-form">
                                                 <div class="form-group d-flex">
                                                     <label>Start Date</label>
                                                        {{ beauty_date(optional($user->helperdetails)->start_date,'d/m/Y') }}
                                                 </div>

                                                 <div class="form-group d-flex">
                                                     <label>End Date</label>
                                                       {{ beauty_date(optional($user->helperdetails)->end_date,'d/m/Y') }}
                                                 </div>                                                    
                                            </div> 
                                        </div>
