        ...
        <div class="row">
            ...
            <div class="col-md-12 col-lg-12">
                <div class="accordion" id="accordionExample">
                	{{ Form::open(array('route' => array('customer.update',$customer->id),'enctype'=>'multipart/form-data'))}}
                		{{method_field('PUT')}}
                        <div class="card">
                                     ...
                                     <fieldset>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <select name="delivery_time" class="form-control {{ $errors->has('delivery_time') ? ' is-invalid' : '' }}">
                                                    ...
                                                    @if(!empty($deliverTime))
                                                        ...
                                                        @if($keyy==$customer->delivery_time)
                                                        <option value="{{$keyy}}" selected="selected">{{$valuee}}</option>
                                                        @else
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <input type="text" name="first_name" value="{{$customer->first_name }}" class="form-control {{ $errors->has('first_name') ? ' is-invalid' : '' }}">
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <input type="text" name="last_name" value="{{ $customer->last_name }}" class="form-control {{ $errors->has('last_name') ? ' is-invalid' : '' }}">
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <input type="text" name="mobile" value="{{ $customer->mobile }}" class="form-control {{ $errors->has('mobile') ? ' is-invalid' : '' }}">
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <input type="text" name="email" value="{{ $customer->email }}" class="form-control {{ $errors->has('email') ? ' is-invalid' : '' }}">
                                                @if ($errors->has('email'))
                                                    <span class="invalid-feedback">
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <input type="text" name="pincode" value="{{ $customer->pincode }}" class="form-control {{ $errors->has('pincode') ? ' is-invalid' : '' }}">
